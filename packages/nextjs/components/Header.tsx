...
import { Bars3Icon, BugAntIcon, EyeIcon, SparklesIcon } from "@heroicons/react/24/outline";
      ...
      <div className="navbar-start w-auto lg:w-1/2">
        ...
        <div className="hidden lg:flex items-center gap-2 ml-4 mr-6">
          ...
          <div className="flex flex-col">
            <span className="font-bold leading-tight">c-entry</span>
            <span className="text-xs">Coordinated Entry</span>
          </div>
        </div>
